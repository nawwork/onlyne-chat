...
class MainWindow(CTk):
    def __init__ (self):
        ...
        self.message = CTkEntry(self, placeholder_text="Type your message here:",
                                height= 40)
